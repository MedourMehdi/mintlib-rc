...
#ifdef __MINT__
 #error "fmtmsg() not implemented. See: https://pubs.opengroup.org/onlinepubs/9799919799/functions/fmtmsg.html"
#else
...
#ifdef __MINT__
 #error "addseverity() not implemented. See: https://man7.org/linux/man-pages/man3/addseverity.3.html"
#else
